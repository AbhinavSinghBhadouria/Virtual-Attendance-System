...
with open('virtual_attendance_system/models/face_recognition_model.pkl', 'rb') as f:
...
attendance_list = []
attendance_record_file = 'attendance_record.txt'
    ...
    while True:
        ...
        for (top, right, bottom, left) in face_locations:
            if len(face_encodings_in_frame) > 0:  # Check if there are any encodings found
                for face_encoding in face_encodings_in_frame:  # Handle all encodings found
...
with open(attendance_record_file, 'w') as f:
